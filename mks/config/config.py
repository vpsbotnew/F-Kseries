...
class Config:
    ...
    ADS = (environ.get("NOR_IMG", "https://telegra.ph/file/bd86e63322f1da29488de.jpg https://telegra.ph/file/b46ad0337d38ceeb9e045.jpg")).split()
    NOR_IMG = ADS 
    ...
    support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001535669773')
    ...
    DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ynkseriesfilter:ynkseriesfilter@ynkseriesfilter.tnn8nnc.mongodb.net/?retryWrites=true&w=majority")
    DATABASE_NAME = environ.get('DATABASE_NAME', "YNKS1")
    DATABASE_NAME2 = environ.get('DATABASE_NAME2', "YNKS2")
